...
def submit_profile():
    ...
    try:
        ...
        if sleep <= 0 or sleep >= 24:
            raise ValueError("Average sleep must be bewteen 0 and 24.")
...
def setup_frames():
    ...
    welcome_label = tk.Label(
        ...
        font=("Arial", 12),
        bg=welcome_frame.cget("bg"),      # blend with background if possible
        fg="#2f2f2f",
        justify="left",
    ...
    returning_name_entry = tk.Entry(returning_frame, font=("Arial", 12), bg="#f4f8fb")
    ...
    name_entry = tk.Entry(profile_frame, font=("Arial", 12), bg="#f4f8fb")
    ...
    age_entry = tk.Entry(profile_frame, font=("Arial", 12), bg="#f4f8fb")
    ...
    neurodivergent_type_entry = tk.Entry(profile_frame, font=("Arial", 12), bg="#f4f8fb")
    ...
    graduation_year_entry = tk.Entry(profile_frame, font=("Arial", 12), bg="#f4f8fb")
    ...
    major_entry = tk.Entry(profile_frame, font=("Arial", 12), bg="#f4f8fb")
    ...
    stress_entry = tk.Entry(profile_frame, font=("Arial", 12), bg="#f4f8fb")
    ...
    average_sleep_entry = tk.Entry(profile_frame, font=("Arial", 12), bg="#f4f8fb")
    ...
    discussion_frame.pack_propagate(False)  # Prevent frame from shrinking to fit contents
    tk.Label(discussion_frame, 
             text="Discussion Groups", 
             font=("Arial", 16), 
             fg="#2f2f2f", 
             bg=discussion_frame.cget("bg")).grid(row=0, column=0, pady=20)
   
    dis_info_label = tk.Label(
    discussion_frame,
    text="Coming Soon!!",         
    font=("Arial", 12),
    ...
    dis_info_label.grid(row=2, column=0, padx=20, pady=10)
...
def setup_menu():
    ...
    connection_menu.add_command(label="Join a Discussion", command=open_discussion_groups)
